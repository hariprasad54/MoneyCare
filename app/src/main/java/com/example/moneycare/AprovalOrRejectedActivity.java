...
public class AprovalOrRejectedActivity extends AppCompatActivity {
    ...
    private EditText userTrnID,refAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refAmount = findViewById(R.id.et_ref_amount);
        ...
        btnSubmitStat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (refAmount.getText().toString().isEmpty()){
                    refAmount.setError("Enter Amount");
                }
                else {
                    amount = Integer.parseInt(refAmount.getText().toString());
...
//                            new BasicUserEntity().setEmail(userEmail.getText().toString()));
                        ...
                        //startActivity(new Intent(getApplicationContext(),AdminApprovalSubActivity.class));
                    }
